export namespace desktop {
	...
	export class IngestEntry {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.skipped_cached = source["skipped_cached"];
	...
	export class IngestState {
	    ...
	    static createFrom(source: any = {}) {
	        return new IngestState(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.active = this.convertValues(source["active"], IngestEntry);
	        this.recent = this.convertValues(source["recent"], IngestEntry);
	    }
	...
	export class TimelineEventDetail {
	    seq: number;
	    ts: string;
	    type: string;
	    source?: string;
